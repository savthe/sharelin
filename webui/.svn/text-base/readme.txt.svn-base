...
created and included (#include) within basic tpl files. Style can be selected in 
webui settings by folder name.

Here how the templates work: Sharelin opens template file and associates several 
arrays (or variables which are the single-element arrays), when all data is set, 
...
You can define variable by using #def command:
#def color #fafafa

There is also if-else statement of the form:
