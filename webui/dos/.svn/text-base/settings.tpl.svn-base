...
<h2 align = left>Settings<br>========</h2>
<FORM name="set" action="set" method="POST" target = "status" class="tinyform">
...
<tr><td><br><h3 align = left>Telnet</h3></td><td></td></tr>
	<tr>
		<td>
			Telnet port*
		</td>
...
<i>blank to disable</i>
	...
	<tr>
		...
		<td>
<INPUT type="text" value = "$telnetpagesize" class="texta" name="telnetpagesize" size="15" maxlen="50">
<i>blank to disable</i>
		</td>
	</tr>
	<tr>
		...
		<td>
<INPUT type="text" value = "$telnetstyle" class="texta" name="telnetstyle" size="15" maxlen="50">
<i>blank for default. Built-in themes: <b>default</b></i>
		</td>
	</tr>

<tr><td><br><h3 align = left>Web Interface</h3></td><td></td></tr>
	<tr>
		<td>
			Web UI port*
		</td>
...
<i>blank to disable</i>
	...
	<tr>
		...
		<td>
<INPUT type="text" value = "$webuipagesize" class="texta" name="webuipagesize" size="15" maxlen="50">
<i>blank to disable</i>
		</td>
	</tr>
	<tr>
...
<INPUT type="text" value = "$listenport" class="texta" name="listenport" size="15" maxlen="50">
			<a target="_blank" href=http://cache.peernix.com/connectiontest/?test=1&port=$listenport>Connection test</a>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
<INPUT type="text" value = "$firewalled" class="texta" name="firewalled" size="15" maxlen="50">
...
<INPUT type="text" value = "$queuesize" class="texta" name="queuesize" size="15" maxlen="50">
	...
	<tr>
		...
		<td>
<INPUT type="text" value = "$maxfiles" class="texta" name="maxfiles" size="15" maxlen="50">
		</td>
	</tr>
	<tr>
		<td>
