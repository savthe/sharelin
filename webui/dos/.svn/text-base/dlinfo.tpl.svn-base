#def reload_query dlinfo%3fid%3d$id
#def reload_period $dlinfo_reload
#def reload_var dlinfo_reload

#include header.tpl

<h2 align = left>Download details<br>
================
</h2>
	<div style = "margin-left:15;">

<table cellspacing = 0 cellpadding = 0 border = 0>
	<tr><td>ID</td> <td>&nbsp;&nbsp;</td> <td><b>$id</b></td></tr>
...
<table cellspacing = 0 cellpadding = 0 border = 1 align = center width = 50% height = 25><tr>
...
<table width = $parts_valid_p% cellspacing = 0 cellpadding = 0><tr><td width = 100% height = 2 bgcolor="yellow"></td> </tr></table>
Not verified: $parts_full  ($parts_full_p%)<br>
<table width = $parts_full_p% cellspacing = 0 cellpadding = 0><tr><td width = 100% height = 2 bgcolor="#999999"></td> </tr></table>
Empty: $parts_empty  ($parts_empty_p%)<br>
<table width = $parts_empty_p% cellspacing = 0 cellpadding = 0><tr><td width = 100% height = 2 bgcolor="black"></td> </tr></table>
Active: $parts_active  ($parts_active_p%)<br>
<table width = $parts_active_p% cellspacing = 0 cellpadding = 0><tr><td width = 100% height = 2 bgcolor="white"></td> </tr></table>
Invalid: $parts_invalid  ($parts_invalid_p%)<br>
<table width = $parts_invalid_p% cellspacing = 0 cellpadding = 0><tr><td width = 100% height = 2 bgcolor="red"></td> </tr></table>
</td></tr></table>
...
<tr>
	...
	#foreach source_number source_endpoint source_connections source_max source_nick1
		<tr>
