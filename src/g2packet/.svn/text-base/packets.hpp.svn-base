...
namespace g2
{
	...
	const PacketType TS = 		StaticName::Encoder<'T', 'S'>::result;
	...
	const PacketType CH = 		StaticName::Encoder<'C', 'H'>::result;
	...
	const PacketType HG = 		StaticName::Encoder<'H', 'G'>::result;
	const PacketType SS = 		StaticName::Encoder<'S', 'S'>::result;
	const PacketType KHL = 		StaticName::Encoder<'K', 'H', 'L'>::result;
